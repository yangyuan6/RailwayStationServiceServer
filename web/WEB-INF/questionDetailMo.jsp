...
<head>
    ...
    <style tpe="text/css">
        ...
        @font-face {
            ...
            src: url('static/font/OyunQaganTig.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */ url('static/font/OyunQaganTig.woff') format('woff'), /* Modern Browsers */ url('static/font/OyunQaganTig.ttf') format('truetype'), /* Safari, Android, iOS */ url('static/font/OyunQaganTig.svg#OyunQaganTig') format('svg'); /* Legacy iOS */
        }
...
<div id="dialog" class="none">
    <div id="dialog-wrapper">
        <div class="dialog-header oldMongolContent">
            <span>ᠠᠰᠠᠭᠤᠯᠲᠠ ᠶᠢᠨ ᠨᠠᠷᠢᠨ ᠪᠠᠢᠳᠠᠯ </span>
        </div>
        <div class="dialog-content oldMongolContent">
            <%--<p><b>${question.questionMo}</b> </p>
            <p><b>${question.answerMo}</b>
             </p>--%>
            <c:choose>
                <c:when test="${msg.state== 0}">
                    <p><b>ᠠᠰᠠᠭᠤᠯᠲᠠ: ${question.questionMo}</b></p>
                    <p>ᠬᠠᠷᠢᠭᠤᠯᠲᠠ: ${question.answerMo}</p>
                    <%-- <audio  id="audio">
                         <source src="<c:url value="/resource/question/mo/q/mon-${question.voice}"/>" type="audio/mpeg">
                     </audio>--%>
                    <audio id="audio1">
                        <source src="<c:url value="/resource/question/mo/a/mon-${question.voice}"/>" type="audio/mpeg">
                    </audio>
                </c:when>
                <c:otherwise>
                    <p>${msg.msg}</p>
        ...
        <div class="dialog-footer">
            <div id="btn_play" class="oldMongolContent" onclick="playVoice()">ᠨᠡᠪᠲᠡᠷᠡᠭᠦᠯᠬᠦ</div>
