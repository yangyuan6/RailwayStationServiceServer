...
<div id="dialog" class="none">
    <div id="dialog-wrapper">
        ...
        <div class="dialog-content oldMongolContent">
            ...
            <p><b>${dataMap["jiangPiaoKou"]}</b> ᠳ᠋ᠤᠭᠠᠷ ᠪᠢᠯᠧᠲ᠋ ᠰᠢᠯᠭᠠᠬᠤ ᠡᠭᠦᠳᠡ ᠪᠠᠷ ᠣᠷᠣᠵᠤ ᠂ <b>${dataMap["station"]}</b>
                ᠤᠭᠠᠷ ᠵᠣᠭᠰᠣᠭᠠᠯ ᠡᠴᠡ ᠲᠡᠷᠭᠡᠨ ᠳᠦ ᠰᠠᠭᠤᠨ᠎ᠠ ᠂ ᠲᠡᠷᠭᠡ  ᠬᠦᠳᠡᠯᠲᠡᠯ ᠡ ᠪᠠᠰᠠ<b>${dataMap['distanceTime']}</b> </p>
            <audio  id="audio">
        ...
        <div class="dialog-footer">
            ...
            <div id="btn_close" class="oldMongolContent"  onclick="toTagetUrl(${ticketMsg.state},'${ticketMsg.url}')">ᠬᠠᠭᠠᠬᠤ</div>
        </div>
    </div>
</div>
