...
<div id="dialog" class="none">
    <div id="dialog-wrapper">
        <div class="dialog-header">
            <span>Details of the question </span>
        </div>
        <div class="dialog-content">
            <c:choose>
                <c:when test="${msg.state== 0}">
                    <p><b>Question: ${question.questionEn}</b></p>
                    <p>Answer: ${question.answerEn}</p>
                    <audio id="audio">
                        <source src="<c:url value="/resource/question/en/${question.voice}"/>" type="audio/mpeg">
                    </audio>
                </c:when>
                <c:otherwise>
                    <p>${msg.msg}</p>
