...
<div id="dialog" class="none">
    <div id="dialog-wrapper">
        ...
        <div class="dialog-content">
            <c:choose>
                <c:when test="${ticketMsg.state== 2}">
                    <p>You take the ${ticketMsg.ticketData.trainNumber} train，</p>
                    <p>go to the <b>${dataMap["witingRoom"]} </b> gate wicket access through the channel to </p>
                     <p>the <b>${dataMap["station"]} </b> platform by car,</p>
                    <p>from the departure of about <b>${dataMap['distanceTime']}</b></p>
                    <audio  id="audio">
                        <%--<source src="http://222.39.6.58:8088/RailwayStationServiceVoice/en/${voice}.wav" type="audio/mpeg">--%>
                            <source src="${audioUrl}/RailwayStationServiceVoice/en/${voice}.wav" type="audio/mpeg">
                    </audio>
                </c:when>
                <c:otherwise>
                    <p>${ticketMsg.msg}</p>
        ...
        <div class="dialog-footer">
            <c:choose>
                <c:when test="${ticketMsg.state== 2}">
                    <button id="btn_play" onclick="playVoice()">play</button>
                </c:when>
            </c:choose>
            <button id="btn_close" onclick="toTagetUrl(${ticketMsg.state},'${ticketMsg.url}')">back</button>
        </div>
    </div>
</div>
