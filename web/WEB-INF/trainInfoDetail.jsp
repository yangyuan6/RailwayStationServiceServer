...
<div id="dialog" class="none">
    <div id="dialog-wrapper">
        ...
        <div class="dialog-content">
            <c:choose>
                <c:when test="${msg.state== 0}">
                    <p><b>${ trainInfo.trainNumber}次列车</b></p>
                    <p><b class="runsection">运行区间： ${ trainInfo.startStation}-->${ trainInfo.terminus}</b></p>
                    <p><b class="kaidian">开点： ${ trainInfo.kaiDian}</b></p>
                    <p><b class="daoDian">到点： ${ trainInfo.daoDian}</b></p>
                    <p>乘车地点： ${ trainInfo.trainStationName}</p>
                    <p>候车室： <b>${ trainInfo.waitingRoom}</b></p>
                    <p>检票口： <b>${ trainInfo.jianPiaoKou}</b></p>
                    <p>站台： <b>${ trainInfo.station}</b></p>
                </c:when>
                <c:otherwise>
                    <p>${msg.msg}</p>
                </c:otherwise>
        ...
        <div class="dialog-footer">
            ...
            <button id="btn_close" onclick="toTagetUrl(${msg.state},'${msg.url}')">关闭</button>
        </div>
    </div>
</div>
