...
<div id="dialog" class="none">
    <div id="dialog-wrapper">
        <div class="dialog-header">
            <span>Тэргэний дүгээрийн мэдээлэл</span>
        </div>
        <div class="dialog-content">
            <c:choose>
                <c:when test="${msg.state== 0}">
                    <p><b>${ trainInfo.trainNumber}Догор / дүгэр галт тэрэг</b></p>
                    <p><b class="runsection">Аялах хүрээ：${ trainInfo.startStationNewMo}-->${ trainInfo.terminusNewMo}</b></p>
                    <p><b class="kaidian">Тэрэг хөдлөх цаг：${ trainInfo.kaiDian}</b></p>
                    <p><b class="daoDian">Тэрэг хөрх цаг：${ trainInfo.daoDian}</b></p>
                    <p>Тэргэнд суух газар：${ trainInfo.trainStationNameNewMo}</p>
                    <p>Тэрэг хүлээх орон：${ trainInfo.waitingRoomNewMo}</p>
                    <p>Билет байцаах үүд：${ trainInfo.jianPiaoKou}</p>
                    <p>Зогсоол：${ trainInfo.station}</p>
                </c:when>
                <c:otherwise>
                    <p>${msg.msg}</p>
                </c:otherwise>
        ...
        <div class="dialog-footer">
            <button id="btn_close" onclick="toTagetUrl(${msg.state},'${msg.url}')">Хаах</button>
        </div>
    </div>
</div>
