...
<div id="wrapper" class="wrapper_l">
    ...
    <div id="head">
        <div class="head_wrapper">
            <div class="s_form">
                <form id="form" name="f" action="${basePath}questionQueryNewMo.php" class="fm">
    ...
    <div id="container" class="container_l">
        ...
        <div id="page">
            <c:if test="${pb.tp>1 }">
                <a
                        href="${basePath}questionQueryNewMo.php?question=${question}&pc=1"
                        class="n">Тэргүүн нигуур</a>
            </c:if>

            <c:if test="${pb.pc > 1 }">
                <a href="${basePath}questionQueryNewMo.php?question=${question}&pc=${pb.pc-1}" class="n">&lt;Дээр нигуур</a>
            </c:if>
            <c:choose>
            ...
            <c:forEach var="i" begin="${begin }" end="${end }">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a
                                href="${basePath}questionQueryNewMo.php?question=${question}&pc=${i}"><span
            ...
            <c:if test="${pb.pc < pb.tp }">
                <a
                        href="${basePath}questionQueryNewMo.php?question=${question}&pc=${pb.pc+1}"
                        class="n">Дараачийн нигуур&gt;</a>
            </c:if>
            <c:if test="${pb.tp>1 }">
                <a href="${basePath}questionQueryNewMo.php?question=${question}&pc=${pb.tp}"  class="n">Эцэс нигуур</a>
            </c:if>
