...
<div id="wrapper" class="wrapper_l">
    <img class="logo" src="${basePath}static/images/logo.gif" alt="">
    <div id="head">
        <div class="head_wrapper">
            <div class="s_form">
                <form id="form" name="f" action="${basePath}questionQueryEn.php" class="fm">
      ...
      <input id="kw"
             ...
             value="${question}"
             maxlength="255"
             autocomplete="off" placeholder="please input the key words">
      </span>
                    <span class="bg s_btn_wr"><input type="submit" id="su" value="search"
                                                     class="bg s_btn"></span>
                </form>
            </div>
        </div>
    ...
    <div id="container" class="container_l">
            ...
            <c:forEach items="${pb.beanList}" var="question">
                <div class="result c-container ">
                    <h3 class="t c-gap-bottom-small">
                        <a
                                href="${basePath}questionDetailEn.php?questionId=${question.id}"
                                >${question.questionEn }</a>
                    </h3>
                    <%--<div class="c-row" >
                            ${question.answerEn }
                    </div>--%>
        ...
        <div id="page">
            <c:if test="${pb.tp>1 }">
                <a
                        href="${basePath}questionQueryEn.php?question=${question}&pc=1"
                        class="n">Home</a>
            </c:if>

            <c:if test="${pb.pc > 1 }">
                <a href="${basePath}questionQueryEn.php?question=${question}&pc=${pb.pc-1}" class="n">&lt;Previous page</a>
            </c:if>
            <c:choose>
            ...
            <c:forEach var="i" begin="${begin }" end="${end }">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a
                                href="${basePath}questionQueryEn.php?question=${question}&pc=${i}"><span
            ...
            <c:if test="${pb.pc < pb.tp }">
                <a
                        href="${basePath}questionQueryEn.php?question=${question}&pc=${pb.pc+1}"
                        class="n">Next page&gt;</a>
            </c:if>
            <c:if test="${pb.tp>1 }">
                <a href="${basePath}questionQueryEn.php?question=${question}&pc=${pb.tp}"  class="n">Last page</a>
            </c:if>
